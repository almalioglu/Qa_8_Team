package student_practice.KelimeOyunu_A;
...
public class KelimeTahminOyunu {
    ...
    public static void adamAsmaca () {
        ...
        int randomIdx= rdm.nextInt(renkler.size());//() icine hangi tamsayiyi koyarsak 0 ile o tamsayi arasinda rastgele secim yapar
